        ...
        <>
            ...
            <div className="container">
                <div className="row order-detail">
                    ...
                    {/* 3 */}
                    <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb -sm-8">
                        <div className="row">
                            '
                            <div className="col-md-4 center">
                                <div className="alert-success order-box">
                            ...
                            <div className="col-md-8 center">
                                ...
                                <p>
                                    Address: Arusha Tz, Ngaramtoni Crater, P.O
                                    BOX 1234 Arusha Tz
                                </p>
                ...
                <div className="row order-products justify-content-between">
                    <div className="col-lg-8">
                        ...
                        <div className="order-product row">
                            ...
                            <div className="mt-3 mt-md-0 col-6_col-md-2 d-flex align-items-center">
                                <h4>QUANTITY</h4>
                                <h6>4</h6>
                            </div>
                            <div className="mt-3 mt-md-o col-md-2 col-6 align-items-end d-flex">
                                <h4>SUBTOTAL</h4>
                                <h6>$456</h6>
                            </div>
                        </div>
